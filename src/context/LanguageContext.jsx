...
export const LanguageProvider = ({ children }) => {
    ...
    const translations = {
        ...
        'Profile': { en: 'Profile', ta: 'புரொபைல்' },
        ...
        'No saved products': { en: 'No saved products', ta: 'சேமித்த பொருட்கள் எதுவும் இல்லை' },
        'Products you mark as favorite will appear here for easy access.': { en: 'Products you mark as favorite will appear here for easy access.', ta: 'நீங்கள் விருப்பமானதாகக் குறிக்கும் பொருட்கள் எளிதான அணுகலுக்கு இங்கே தோன்றும்.' },
        'Products you add to your cart will appear here for checkout.': { en: 'Products you add to your cart will appear here for checkout.', ta: 'நீங்கள் கார்ட்டில் சேர்க்கும் பொருட்கள் செக்அவுட்டுக்கு இங்கே தோன்றும்.' },
        'Your selected items': { en: 'Your selected items', ta: 'நீங்கள் தேர்ந்தெடுத்த பொருட்கள்' },
        ...
        'My Address': { en: 'My Address', ta: 'எனது முகவரி' },
        'Street / Area': { en: 'Street / Area', ta: 'தெரு / பகுதி' },
        'Pin exact GPS': { en: 'Pin exact GPS', ta: 'துல்லியமான ஜிபிஎஸ்' },
        'Location Attached': { en: 'Location Attached', ta: 'இடம் இணைக்கப்பட்டது' },
        'Update Address': { en: 'Update Address', ta: 'முகவரியைப் புதுப்பிக்கவும்' },
        'Recipient Name': { en: 'Recipient Name', ta: 'பெறுநரின் பெயர்' },
        ...
        'Select Location': { en: 'Select Location', ta: 'இடத்தைத் தேர்ந்தெடுக்கவும்' },
        ...
        'Logout': { en: 'Logout', ta: 'லாக் அவுட்' },
        ...
        'Processing': { en: 'Processing', ta: 'Processing' },
        'Shipped': { en: 'Shipped', ta: 'Shipped' },
        'Delivered': { en: 'Delivered', ta: 'Delivered' },
        'Cancelled': { en: 'Cancelled', ta: 'Cancelled' },
        'Out for Delivery': { en: 'Out for Delivery', ta: 'Out for Delivery' },
        ...
        'Ready to Wrap Up?': { en: 'Ready to Wrap Up?', ta: 'முடிக்கத் தயாரா?' },
        'You are just one step away from confirming your order. Do you want to proceed?': { en: 'You are just one step away from confirming your order. Do you want to proceed?', ta: 'உங்கள் ஆர்டரை உறுதிப்படுத்துவதற்கு ஒரு படி தூரத்தில் உள்ளீர்கள். தொடர விரும்புகிறீர்களா?' },
        'Order Placed!': { en: 'Order Placed!', ta: 'ஆர்டர் செய்யப்பட்டது!' },
        'Order Placed': { en: 'Order Placed', ta: 'Order Placed' },
        'Items Ordered': { en: 'Items Ordered', ta: 'ஆர்டர் செய்யப்பட்ட பொருட்கள்' },
        'Delivery To': { en: 'Delivery To', ta: 'டெலிவரி முகவரி' },
        'Payment Summary': { en: 'Payment Summary', ta: 'கட்டண சுருக்கம்' },
        'Item Total': { en: 'Item Total', ta: 'பொருட்களின் மொத்தம்' },
        'Delivery Fee': { en: 'Delivery Fee', ta: 'டெலிவரி கட்டணம்' },
        'Grand Total': { en: 'Grand Total', ta: 'மொத்த தொகை' },
        'Your order has been placed successfully.': { en: 'Your order has been placed successfully.', ta: 'உங்கள் ஆர்டர் வெற்றிகரமாக செய்யப்பட்டது.' },
        'Go to Orders': { en: 'Go to Orders', ta: 'ஆர்டர்களுக்குச் செல்லவும்' },
        'Confirm Request': { en: 'Confirm Request', ta: 'கோரிக்கையை உறுதிப்படுத்தவும்' },
        'Are you sure you want to request': { en: 'Are you sure you want to request', ta: 'நிச்சயமாக நீங்கள் கோர விரும்புகிறீர்களா' },
        'Confirm': { en: 'Confirm', ta: 'உறுதிப்படுத்து' },
        'Request Sent!': { en: 'Request Sent!', ta: 'கோரிக்கை அனுப்பப்பட்டது!' },
        'Your request for': { en: 'Your request for', ta: 'உங்களுக்கான கோரிக்கை' },
        'has been received': { en: 'has been received', ta: 'பெறப்பட்டது' },
        'Our team will contact you shortly': { en: 'Our team will contact you shortly', ta: 'எங்கள் குழு விரைவில் உங்களைத் தொடர்பு கொள்ளும்' },
        ...
        'My Orders': { en: 'My Orders', ta: 'ஆர்டர்' },
        'Saved Products': { en: 'Saved Products', ta: 'சேமித்தவை' },
        'News': { en: 'News', ta: 'செய்தி' },
        'Games': { en: 'Games', ta: 'விளையாட்டுகள்' },
        'My Store': { en: 'My Store', ta: 'எனது கடை' },
        'Settings': { en: 'Settings', ta: 'செட்டிங்ஸ்' },
        'Help Center': { en: 'Help Center', ta: 'ஹெல்ப்' },
        'Manage account': { en: 'Manage account', ta: 'அக்கவுண்ட்' },
        'Account': { en: 'Account', ta: 'அக்கவுண்ட்' },
        'Support': { en: 'Support', ta: 'சப்போர்ட்' },
        ...
        'Completed': { en: 'Completed', ta: 'Completed' },
        ...
        'Track packages': { en: 'Track packages', ta: 'கண்காணிக்கவும்' },
        ...
        'Delivery to': { en: 'Delivery to', ta: 'முகவரி' },
        ...
        'Locating...': { en: 'Locating...', ta: 'இருப்பிடத்தைக் கண்டறிகிறது...' },
        'Finding location...': { en: 'Finding location...', ta: 'இருப்பிடத்தைக் கண்டறிகிறது...' },
        'Use My Current Location': { en: 'Use My Current Location', ta: 'எனது தற்போதைய இடத்தைப் பயன்படுத்தவும்' },
        'Location Accessed Successfully': { en: 'Location Accessed Successfully', ta: 'இருப்பிடம் வெற்றிகரமாக அணுகப்பட்டது' },
        ...
        'Location is blocked by Windows. Please enable "Location Services" in Windows Settings.': { en: 'Location is blocked by Windows. Please enable "Location Services" in Windows Settings.', ta: 'விண்டோஸால் இருப்பிடம் தடுக்கப்பட்டுள்ளது. விண்டோஸ் அமைப்புகளில் "இருப்பிட சேவைகளை" இயக்கவும்.' },
        'Location request timed out. Please try again in an open area or turn on Wi-Fi.': { en: 'Location request timed out. Please try again in an open area or turn on Wi-Fi.', ta: 'இருப்பிடக் கோரிக்கை காலாவதியானது. தயவுசெய்து திறந்த வெளியில் முயற்சிக்கவும் அல்லது வைஃபையை ஆன் செய்யவும்.' },
        'Geolocation is not supported by your browser': { en: 'Geolocation is not supported by your browser', ta: 'உங்கள் உலாவியில் புவிஇருப்பிடம் ஆதரிக்கப்படவில்லை' },
        'Unable to get location': { en: 'Unable to get location', ta: 'இருப்பிடத்தைப் பெற முடியவில்லை' },
        'Location not detected. Please ensure your GPS/Wi-Fi is on and try again.': { en: 'Location not detected. Please ensure your GPS/Wi-Fi is on and try again.', ta: 'இருப்பிடம் கண்டறியப்படவில்லை. உங்கள் ஜிபிஎஸ்/வைஃபை ஆன் செய்யப்பட்டுள்ளதா என்பதை உறுதிசெய்து மீண்டும் முயற்சிக்கவும்.' },
        'Save Shipping Details': { en: 'Save Shipping Details', ta: 'ஷிப்பிங் விவரங்களைச் சேமிக்கவும்' },
        'Full Address': { en: 'Full Address', ta: 'முழு முகவரி' },
        'House no, Flat, Street name, Landmark': { en: 'House no, Flat, Street name, Landmark', ta: 'வீட்டு எண், பிளாட், தெரு பெயர், அடையாளச் சின்னம்' },
        'Enter 10-digit mobile number': { en: 'Enter 10-digit mobile number', ta: '10 இலக்க மொபைல் எண்ணை உள்ளிடவும்' },
        'Select City': { en: 'Select City', ta: 'நகரத்தைத் தேர்ந்தெடுக்கவும்' },
        'ZIP Code': { en: 'ZIP Code', ta: 'அஞ்சல் குறியீடு (ZIP)' },
        'Please sign in to continue with checkout': { en: 'Please sign in to continue with checkout', ta: 'செக்அவுட்டைத் தொடர தயவுசெய்து உள்நுழையவும்' },
        'Please fill in all required fields': { en: 'Please fill in all required fields', ta: 'தேவையான அனைத்து புலங்களையும் நிரப்பவும்' },
        'Please enter a valid 10-digit mobile number': { en: 'Please enter a valid 10-digit mobile number', ta: 'சரியான 10 இலக்க மொபைல் எண்ணை உள்ளிடவும்' },
        'Please enter a valid 6-digit Pincode': { en: 'Please enter a valid 6-digit Pincode', ta: 'சரியான 6 இலக்க பின்கோடை உள்ளிடவும்' },
        'No Name': { en: 'No Name', ta: 'பெயர் இல்லை' },
        'Address updated successfully!': { en: 'Address updated successfully!', ta: 'முகவரி வெற்றிகரமாக புதுப்பிக்கப்பட்டது!' },
    ...
    const t = (key, field = null) => {
        ...
        if (typeof key === 'object' && key !== null && field) {
            // Priority: field_ta (if ta), field_en (if en), then direct field
            const langField = `${field}_${language}`;
            const enField = `${field}_en`;
            return key[langField] || key[enField] || key[field] || '';
        }
